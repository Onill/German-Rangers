[
	transformer_3,										// Object the action is attached to
	...
	{[_caller] execVM "scripts\transformerRepair3.sqf"},		// Code executed on completion
...
] remoteExec ["BIS_fnc_holdActionAdd", 0, transformer_3];		// MP compatible implementation