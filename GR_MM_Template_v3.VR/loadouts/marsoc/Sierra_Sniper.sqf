...
player addPrimaryWeaponItem "cup_optic_an_pvs_10_black";
player addPrimaryWeaponItem "cup_bipod_harris_1a2_l_blk";
player addPrimaryWeaponItem "muzzle_snds_B";

//Waffen Munition
player addPrimaryWeaponItem "ACE_7Rnd_408_305gr_Mag";
...
//	Munition
//------------------------------------------------------------------	
for "_i" from 1 to 5 do {player addItemToVest "ACE_7Rnd_408_305gr_Mag";};
