...
//Standard Mags
_box addMagazineCargoGlobal ["CUP_20Rnd_762x51_B_SCAR_bkl", 999];
_box addMagazineCargoGlobal ["CUP_20Rnd_TE1_Red_Tracer_762x51_SCAR_bkl", 600];
...
_box addItemCargoGlobal ["150Rnd_762x51_Box", 500];
_box addItemCargoGlobal ["150Rnd_762x51_Box_Tracer", 500];

_box addItemCargoGlobal ["CUP_100Rnd_TE4_LRT4_Red_Tracer_762x51_Belt_M", 500];
...
_box addItemCargoGlobal ["CUP_5Rnd_762x67_M2010_M", 500];
_box addItemCargoGlobal ["CUP_5Rnd_TE1_Red_Tracer_762x67_M2010_M", 500];
_box addItemCargoGlobal ["7Rnd_408_Mag", 500];


//Echo
_box addItemCargoGlobal ["CUP_12Rnd_45ACP_mk23", 500];
...
//AT
_box addItemCargoGlobal ["Titan_AT",20];
