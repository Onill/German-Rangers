...
for "_i" from 1 to 4 do {player addItemToVest "kat_larynx";};
...
for "_i" from 1 to 8 do {player addItemToVest "CUP_HandGrenade_M67";};
...
player addItemToBackpack "CUP_glaunch_M32";
for "_i" from 1 to 2 do {player addItemToBackpack "CUP_6Rnd_Smoke_M203";};
for "_i" from 1 to 4 do {player addItemToBackpack "CUP_6Rnd_HE_M203";};
