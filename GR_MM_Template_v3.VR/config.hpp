...
lima				= true;			//Sets if a Lima Supply Point is available for all Players in Groups Lima and Kilo(Needs adjusted supply boxes in Lima folder for the Fraktion)
