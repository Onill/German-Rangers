[
	transformer_2,										// Object the action is attached to
	...
	{[_caller] execVM "scripts\transformerRepair2.sqf"},		// Code executed on completion
...
] remoteExec ["BIS_fnc_holdActionAdd", 0, transformer_2];		// MP compatible implementation