...
for "_i" from 1 to 5 do {player addItemToVest "CUP_20Rnd_762x51_HK417_Camo_Desert";};
for "_i" from 1 to 2 do {player addItemToVest "CUP_21Rnd_9x19_M17_Black";};
for "_i" from 1 to 2 do {player addItemToVest "SmokeShell";};
player addItemToVest "SmokeShellGreen";
player addItemToVest "SmokeShellRed";for "_i" from 1 to 5 do {player addItemToBackpack "kat_IV_16";};
